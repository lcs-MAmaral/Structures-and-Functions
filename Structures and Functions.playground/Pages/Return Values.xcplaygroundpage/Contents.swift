...
/// This function takes two points and finds the length of that line.
///
/// - Parameters:
///   - fromX: The starting x
///   - fromY: The starting y
///   - toX: the ending x
///   - toY: the ending y
/// - Returns: This is the value that is retured to the computer from the math
